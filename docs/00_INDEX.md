...
Формальный комплект по состоянию кода: [technical_documentation/00_INDEX.md](technical_documentation/00_INDEX.md) — технические требования, ТЗ, пояснительная записка, методика испытаний (версия макросов **3.10.696**).
